...
class TestMilestone1PwaWebPlatform(unittest.TestCase):
    ...
    def test_02_service_worker_caching_and_lifecycle(self):
        """Verify sw.js defines static asset precaching, install, activate, and fetch handlers."""
    ...
    # -------------------------------------------------------------
    # 3. index.html PWA Integration
    # -------------------------------------------------------------
    def test_03_index_html_pwa_tags_and_scripts(self):
        """Verify index.html includes manifest link, favicon, and all core components."""
