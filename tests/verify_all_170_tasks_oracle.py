...
class TestAll170MicroTasksOracle(unittest.TestCase):
    ...
    def test_l01_tasks_oracle(self):
        ...
        self.assertTrue("200" in tasks[2]["solution"] or "784" in tasks[2]["solution"] or "256" in tasks[2]["solution"])
        self.assertTrue("-0.6" in tasks[3]["solution"] or "\\delta" in tasks[3]["solution"])
        self.assertTrue("150" in tasks[4]["solution"] or "0.01333" in tasks[4]["solution"] or "Xavier" in tasks[4]["solution"])
    ...
    def test_l02_tasks_oracle(self):
        ...
        self.assertTrue("u''" in tasks[4]["solution"] or "0" in tasks[4]["solution"] or "w" in tasks[4]["solution"])
    ...
    def test_l03_tasks_oracle(self):
        ...
        self.assertEqual(len(tasks), 6)
        self.assertTrue("NLL" in tasks[0]["solution"] or "2\\pi" in tasks[0]["solution"] or "\\sigma" in tasks[0]["solution"])
        self.assertTrue("0.10" in tasks[1]["solution"] or "\\ell" in tasks[1]["solution"])
        self.assertTrue("2.7183" in tasks[2]["solution"] or "7.3891" in tasks[2]["solution"] or "11" in tasks[2]["solution"])
        self.assertTrue("1.8651" in tasks[3]["solution"] or "FL" in tasks[3]["solution"] or "0.81" in tasks[3]["solution"])
        self.assertTrue("MAP" in tasks[4]["solution"] or "\\log" in tasks[4]["solution"] or "2\\sigma" in tasks[4]["solution"])
    ...
    def test_l04_tasks_oracle(self):
        ...
        self.assertTrue("224" in tasks[0]["solution"] or "7" in tasks[0]["solution"] or "112" in tasks[0]["solution"])
        self.assertTrue("64" in tasks[1]["solution"] or "3" in tasks[1]["solution"] or "Params" in tasks[1]["solution"])
        self.assertTrue("RF" in tasks[2]["solution"] or "1" in tasks[2]["solution"] or "3" in tasks[2]["solution"])
        self.assertTrue("MaxPool" in tasks[3]["solution"] or "9" in tasks[3]["solution"] or "2" in tasks[3]["solution"])
        self.assertTrue("\\mu_B" in tasks[4]["solution"] or "5.0" in tasks[4]["solution"])
        self.assertTrue("294" in tasks[5]["solution"] or "128" in tasks[5]["solution"] or "256" in tasks[5]["solution"])
        self.assertTrue("K_{eff}" in tasks[6]["solution"] or "3" in tasks[6]["solution"] or "2" in tasks[6]["solution"])
